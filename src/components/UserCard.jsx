...
const UserCard = ({
  ...
  return (
    <div
      className={`${gradientBorder ? gradientBorder : "p-[4px]"} ${rounded ? rounded : "rounded-xl"} bg-gradient-to-r ${gradientWidth ? gradientWidth : ""} ${gradientHeight ? gradientHeight : ""} gradient-border`}
      style={{
